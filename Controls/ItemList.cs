    ...
    public class ItemList : Control, IList<ItemList.Item>
    {
        ...
        private void RecalculateContentHeight()
        {
            ...
            foreach (var item in _itemList)
            {
                ...
                itemHeight = Math.Max(itemHeight, ActualFont.GetLineHeight(UIScale));
        ...
        public Item AddItem(string text, Texture2D icon = null, bool selectable = true)
        {
        ...
        protected internal override async void MouseButtonDown(GUIMouseButtonEventArgs args)
        {
            ...
            foreach (var item in _itemList)
            {
                ...
                if (item.Selectable && !item.Disabled)
                {
                    ...
                    {   
                        await Task.Delay(ButtonDeselectDelay);
                        item.Selected = false;
                    }
                }
                break;
