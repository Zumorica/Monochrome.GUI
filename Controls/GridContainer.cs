...
namespace Monochrome.GUI.Controls
{
    ...
    public class GridContainer : Container
    {
        ...
        private Point Separations => new Point(_hSeparationOverride ?? 4, _vSeparationOverride ?? 4);

        protected override Vector2 CalculateMinimumSize()
        {
            var (wSep, hSep) = (Separations.ToVector2() * UIScale).ToPoint();
            var rows = Rows;
        ...
        protected override void LayoutUpdateOverride()
        {
            ...
            var (vSep, hSep) = (Separations.ToVector2() * UIScale).ToPoint();
            var stretchMinX = 0;
            var stretchMinY = 0;
