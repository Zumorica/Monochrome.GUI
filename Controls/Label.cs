...
namespace Monochrome.GUI.Controls
{
    ...
    public class Label : Control
    {
        ...
        public SpriteFont FontOverride { get; set; }

        private SpriteFont ActualFont
        {
            get
            {
                ...
                if (TryGetStyleProperty<SpriteFont>(StylePropertyFont, out var font))
                {
                    return font;
                }
        ...
        protected internal override void Draw(DrawingHandleScreen handle)
        {
            ...
            if (!_textDimensionCacheValid)
            {
                ...
                Debug.Assert(_textDimensionCacheValid);
            }
