    ...
    public class ScrollContainer : Container
    {
        ...
        protected override void LayoutUpdateOverride()
        {
            ...
            foreach (var child in Children)
            {
                ...
                maxChildMinSize = Vector2Helper.ComponentMax(child.CombinedMinimumSize, maxChildMinSize);
            }
            ...
            foreach (var child in Children)
            {
                ...
                var rect = UIBox2.FromDimensions(position, Vector2Helper.ComponentMax(child.CombinedMinimumSize, sSize));
