...
namespace Monochrome.GUI.Controls
{
    ...
    public class OutputPanel : Control
    {
        ...
        public void RemoveLine(int line)
        {
            ...
            var font = _getFont();
            _totalContentHeight -= entry.Height + font.GetLineHeight(UIScale);
            if (_entries.Count == 0)
            {
                Clear();
            }
        ...
        public void AddMessage(FormattedMessage message)
        {
            ...
            {
                _totalContentHeight += font.GetLineHeight(UIScale);
            }
        ...
        protected internal override void Draw(DrawingHandleScreen handle)
        {
            ...
            foreach (var entry in _entries)
            {
                ...
                {
                    entryOffset += entry.Height + font.GetLineHeight(UIScale);
                    continue;
                }
