...
namespace Monochrome.GUI
{
    public partial class Control
    {
        ...
        /// </summary>
        public Point PixelSize => (_size * UserInterfaceManager.UIScale).ToPoint();
        ...
        public UIBox2i PixelSizeBox => new UIBox2i(Point.Zero, PixelSize);
        ...
        public Point PixelPosition => (Position * UserInterfaceManager.UIScale).ToPoint();
        ...
        /// </summary>
        /// <seealso cref="GlobalPosition"/>
        public Point GlobalPixelPosition
        {
            get
            {
        ...
        public Vector2 CombinedMinimumSize
        {
            get
            {
                ...
                {
                    _updateMinimumSize();
                    Debug.Assert(_calculatedMinimumSize.HasValue);
                }

                return Vector2Helper.ComponentMax(CustomMinimumSize, _calculatedMinimumSize.Value);
            }
        }
        ...
        /// </summary>
        public Point CombinedPixelMinimumSize => (CombinedMinimumSize * UIScale).ToPoint();
        ...
        public Vector2 CustomMinimumSize
        {
            ...
            set
            {
                _customMinimumSize = Vector2Helper.ComponentMax(Vector2.Zero, value);
                MinimumSizeChanged();
            }
        }
        ...
        private void _updateMinimumSize()
        {
            ...
            _calculatedMinimumSize = Vector2Helper.ComponentMax(Vector2.Zero, CalculateMinimumSize());
        }
        ...
        {
            var topLeft = pixelBox.TopLeft.ToVector2() / UIScale;
            var bottomRight = pixelBox.BottomRight.ToVector2() / UIScale;
