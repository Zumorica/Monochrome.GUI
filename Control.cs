...
namespace Monochrome.GUI
{
    ...
    public partial class Control : IDisposable
    {
        ...
        public Control()
        {
            UserInterfaceManagerInternal = GUIGameComponent.Singleton.UserInterfaceManager;
        ...
        {
            Debug.Assert(!Disposed, "Control has been disposed.");
        ...
        public void AddChild(Control child)
        {
            ...
            Debug.Assert(!child.Disposed, "Child is disposed.");
        ...
        internal void DoUpdate(GameTime args)
        {
            Update(args);
            foreach (var child in Children)
            {
        ...
        /// </summary>
        protected virtual void Update(GameTime args)
        {
        }

        internal void DoFrameUpdate(GameTime args)
        {
            FrameUpdate(args);
            foreach (var child in Children)
            {
        ...
        /// </summary>
        protected virtual void FrameUpdate(GameTime args)
        {
        }
